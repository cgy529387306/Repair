...
/**
 * Created by AAA on 2019/1/11
 */
public class WorkerSignInActivity extends BaseActivity {
        ...
        public void onGetGeoCodeResult(GeoCodeResult result) {
            if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
                ...
                BitmapDescriptor mCurrentMarker = BitmapDescriptorFactory
                        .fromView(View.inflate(WorkerSignInActivity.this, R.layout.view_location_icon, null));
...
//                    map.put("addr2", et_detail.getText().toString());
    ...
    protected int getLayoutResId() {
        return R.layout.act_worker_sign_in;
    }
        ...
        mCountDownTextView.setNormalText("获取验证码")
                ...
                .setOnCountDownFinishListener(new CountDownTextView.OnCountDownFinishListener() {
                    ...
                    public void onFinish() {
                        Toast.makeText(WorkerSignInActivity.this, "倒计时完毕", Toast.LENGTH_SHORT).show();
                    }
                })
                .setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(WorkerSignInActivity.this, "短信已发送", Toast.LENGTH_SHORT).show();
    ...
    class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            // 设置自定义图标
            BitmapDescriptor mCurrentMarker = BitmapDescriptorFactory
                    .fromView(View.inflate(WorkerSignInActivity.this, R.layout.view_location_icon_my, null));
...
//            mBaiduMap.addOverlay(ooText);
            ...
            if (location.getLocType() == BDLocation.TypeGpsLocation) {
                ...
                Toast.makeText(WorkerSignInActivity.this, "服务器错误，请检查", Toast.LENGTH_SHORT).show();
            } else if (location.getLocType() == BDLocation.TypeNetWorkException) {
                Toast.makeText(WorkerSignInActivity.this, "网络错误，请检查", Toast.LENGTH_SHORT).show();
            } else if (location.getLocType() == BDLocation.TypeCriteriaException) {
                Toast.makeText(WorkerSignInActivity.this, "请确认手机是否开启GPS", Toast.LENGTH_SHORT).show();
            }
